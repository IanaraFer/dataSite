...
class PDFReportGenerator:
    ...
    def generate_business_report(self, df: pd.DataFrame, analysis_results: Dict[str, Any]) -> bytes:
        ...
        try:
            ...
            Contact: analyticacoreai@outlook.com
    ...
    def generate_html_report(self, df: pd.DataFrame, analysis_results: Dict[str, Any]) -> bytes:
        ...
        try:
            ...
            <body>
                ...
                <div class="section">
                    <h2>Contact</h2>
                    <p>AnalyticaCore AI - analyticacoreai@outlook.com</p>
                </div>
            </body>
            </html>
            """
        ...
        <div class="main-header">
            ...
            <div class="contact-info">
                <div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap;">
                    <div><strong>📧 Contact:</strong> analyticacoreai@outlook.com</div>
        ...
        if st.session_state.data_loaded:
            ...
            <div style="text-align: center; padding: 3rem;">
                ...
                <p style="margin-top: 2rem; color: #888;">
                    ...
                    <strong>Contact:</strong> analyticacoreai@outlook.com |
