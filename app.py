    ...
    def generate_html_report(self, df: pd.DataFrame, analysis_results: Dict[str, Any]) -> bytes:
        ...
        try:
            ...
            <body>
                ...
                <div class="section">
                    <h2>Contact</h2>
                    <p>AnalyticaCore AI - founder@analyticacoreai.com</p>
                </div>
            </body>
            </html>
            """
...
def create_download_link(data: bytes, filename: str, text: str) -> str:
    ...
    try:
        ...
        href = f'<a href="data:application/octet-stream;base64,{b64}" download="{filename}" class="download-button">{text}</a>'
        return href
    except Exception as e:
        logger.error(f"Error creating download link: {str(e)}")
        return f"<span>Download error: {str(e)}</span>"
        ...
        <div class="main-header">
            ...
            <div class="contact-info">
                <div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap;">
                    <div><strong>📧 Contact:</strong> founder@analyticacoreai.com</div>
        ...
        if st.session_state.data_loaded:
                ...
                if st.sidebar.button("📊 Generate Business Report", use_container_width=True):
                    with st.spinner("Generating professional PDF report..."):
                        try:
                            ...
                            download_link = create_download_link(report_data, filename, "📥 Download Report")
            ...
            <div style="text-align: center; padding: 3rem;">
                ...
                <p style="margin-top: 2rem; color: #888;">
                    ...
                    <strong>Contact:</strong> founder@analyticacoreai.com |
